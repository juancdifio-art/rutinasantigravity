    ...
    return (
        <div className="min-h-screen font-sans text-slate-200">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xl font-bold text-white tracking-tight">GymManager</span>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="hidden sm:flex items-center gap-2 text-sm font-medium text-slate-400 bg-slate-900/50 px-4 py-2 rounded-full border border-slate-800">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Tabs */}
                <div className="flex p-1.5 bg-slate-900/60 backdrop-blur-sm rounded-2xl shadow-lg shadow-black/20 border border-slate-800 mb-8 w-fit mx-auto sm:mx-0">
                    {tabs.map((tab) => {
                        const Icon = tab.icon;
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    ${isActive ? 'text-blue-400 shadow-sm' : 'text-slate-400 hover:text-slate-200 hover:bg-slate-800/50'}
                                `}
                            >
                                {isActive && (
                                    <motion.div
                                        layoutId="activeTab"
                                        className="absolute inset-0 bg-slate-800 rounded-xl shadow-sm border border-slate-700"
                                        initial={false}
